...
import com.example.apiiit_rkv.SampleApplication.utils.SampleMath;
import com.example.apiiit_rkv.SampleApplication.utils.SampleUtils;
...
import com.example.apiiit_rkv.VideoPlayback.app.VideoPlayback.VideoPlayerHelper.MEDIA_TYPE;
...
//            JSONObject jsonObjectson = null;
            ...
            try {
                JSONObject jsonObject = new JSONObject(new_url);
                metadataJson = jsonObject.getJSONObject("maincontent");
                new_url = metadataJson.getString("url");
                Log.d("Hello1", new_url);
//                type = (String) metadataJson.get("type");

            } catch (JSONException e) {
                Log.d("Hello1", "In Exception");
                e.printStackTrace();
                new_url=imageTarget.getMetaData();
            }
